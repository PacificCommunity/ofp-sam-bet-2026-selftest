...
The generating model and every refit fix the negative-binomial tag overdispersion parameter at τ = 2. The report includes annual recovery, key assessment-quantity and parameter recovery, pseudo-data centring checks, and publication figures with Word/LaTeX-ready captions.
